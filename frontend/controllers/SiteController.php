...
use frontend\models\RestaurantFrontendForm;
...
class SiteController extends Controller
{
	...
	public function behaviors()
	{
		return [
			'access' => [
				...
				'only'  => ['logout', 'signup', static::ACTION_RESTAURANT],
				'rules' => [
					[
						'actions' => ['signup'],
						'allow'   => true,
					...
					[
						'actions' => ['logout', static::ACTION_RESTAURANT],
						'allow'   => true,
						'roles'   => ['@'],
					],
	...
	{
		$this->view->title = 'Добавить ресторан';

		$form = new RestaurantFrontendForm(new RefRestaurant());
